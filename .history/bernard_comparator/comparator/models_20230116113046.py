...
for id_value, name in data["name"].items():
    ...
    model.set_price(id=id_value, style=data["price"][id_value])
    model.set_reduction_price(
        id=id_value, style=data["reduction_price"][id_value])
    model.set_url(id=id_value, style=data["url"][id_value])
    model.set_url_image(id=id_value, style=data["url_image"][id_value])
    model.set_website(id=id_value, style=data["website"][id_value])
    model.save()
