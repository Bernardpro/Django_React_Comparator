            ...
            <section id="presentation">
                ...
                <div id="presentationCategories">
                    <div className='imagesPresentationCategories'>
                        <ImageWithLink path="/regularjean" src="./images/regular_jean.png" alt="Jean regular"/>
                    </div>
                    <div className='imagesPresentationCategories'>
                    ...
                    <div className='imagesPresentationCategories'>
                        <ImageWithLink path="/relaxjean" src="./images/relax_jean.png" alt="Jean relax"/>
                    </div>
                    <div className='imagesPresentationCategories'>
                        <ImageWithLink path="/loosejean" src="./images/loose_jean.png" alt="Jean loose"/>
                    </div>
                    <div className='imagesPresentationCategories'>
                        <ImageWithLink path="/skinnyjean" src="./images/skinny_jean.png" alt="Jean skinny"/>
                    </div>
                </div>
            </section>
            <Footer/>
